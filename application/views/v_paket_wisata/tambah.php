...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?php base_url('c_paket_wisata/tambah_data/'); ?>" method="post"
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="id_tempat_makan">
                        ...
                        <option value="<?php echo $tm['id_tempat_makan']; ?>"><?php echo $tm['nama_tempat_makan']; ?>
                        </option>
                        <?php endforeach ?>
                    </select>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nama_paket_wisata" name="nama_paket_wisata"
                        placeholder="Contoh : Paket Wisata Hemat 1">
                ...
                <div class="form-group">
                    ...
                    <select class="form-control selectpicker" multiple title="--Pilih Destinasi Tujuan--"
                        data-live-search="true" name="id_destinasi_tujuan[]" data-max-options="3"
                        data-max-options-text="Maximal 3 Destinasi yang dapat dipilih">
                        <?php foreach ($destinasi_tujuan as $d) : ?>
                        <option value="<?php echo $d['id_destinasi_tujuan']; ?>">
                            <?php echo $d['nama_destinasi_tujuan']; ?></option>
                        <?php endforeach ?>
                ...
                <a href="<?php echo base_url() . 'c_paket_wisata/tampil_data' ?>" class="btn btn-secondary"><i
