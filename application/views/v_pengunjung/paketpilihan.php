        ...
        <div class="row g-5">
            ...
            <div class="col-lg-5">
                <div class="box position-relative">
                    ...
                    <a href="https://wa.me/+6285824458579" class="btn-primary nav-item nav-link" style="border-radius: 20px; margin-top: 20px;"><i class="me-2 fab fa-whatsapp"></i>Hubungi Melalui WhattsApp</a>
                </div>
                <br>
                <hr />
                <?php if ($check == 0) { ?>
                        ...
                        <form method="POST" action="<?php echo base_url('c_pengunjung/ubah_data_rating'); ?>">
                            ...
                            <?php foreach ($deteksi_post_rating as $dpr) : ?>
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="rating" value="5" <?php if (isset($dpr['rating']) && $dpr['rating'] == 5) {
                                                                                                                        echo 'checked';
                                                                                                                    } ?>>
                                            <li class="fa fa-star text-warning"></li>
                                            <li class="fa fa-star text-warning"></li>
